...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOUVEMENTSSTOCK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MOUVEMENTSSTOCK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MOUVEMENTSSTOCK actions', async () => {
    ...
    it('dispatches UPDATE_MOUVEMENTSSTOCK actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_MOUVEMENTSSTOCK actions', async () => {
    ...
    it('dispatches DELETE_MOUVEMENTSSTOCK actions', async () => {
      const arg = 42666;
